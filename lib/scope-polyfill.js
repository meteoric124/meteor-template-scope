...
export let scope_polyfill = { currentTemplateWithScope: null };

function single_node () {
    let is_single_node = this.firstNode == this.lastNode;
...
Template.onCreated(function() {
    ...
    let $scopedParentTemplate = this.parent(t => isDefined(t.$scope), true) || scope_polyfill.currentTemplateWithScope;
